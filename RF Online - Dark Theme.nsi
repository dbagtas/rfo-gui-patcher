...
SectionGroup /e "Dark UI / Theme" Section_One
	...
	Section "Dark User Interface" Dark_UI
		...
		!insertmacro BackupFile "$INSTDIR\SpriteImage\en-us" "patriarch.spr" "$INSTDIR\SpriteImage\en-us"			
		File ".\Files_To_Install\SpriteImage\en-us\patriarch.spr"		
...
Section "Uninstall"
  ...
  !insertmacro RestoreFile "$INSTDIR\SpriteImage\en-us" "patriarch.spr" "$INSTDIR\SpriteImage\en-us" 
